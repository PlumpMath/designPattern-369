...
public class Client {
    ...
    Philosophy:
         ...
         Decorator pattern is used when we want to add features to a already create object at runtime. We take the object create and wrap some decoreated object on
         ...
         Plain Pizza is giving us the basic obecct. Now we want to build addition functionality on top of it, like adding sauce, adding cheese.
         ...
         The extra functionality classes would inherit the decorator class which would take the type of basic object as input (pizza type here).
          ...
          Sauce wraps around cheese which wraps around plain pizza.
           ...
           The functions provided by the basic object (plain pizza) are used in the decorator class as well so that the functionality of the similar mentod can be
